...
import './style/ProvinceManagementTable.css';
...
const ProvinceManagementTable = () => {
  ...
  return (
    <div className="table-main">
      <h4 className="ps-3 py-2 table-heading">Province List Management</h4>
...
export default ProvinceManagementTable;
